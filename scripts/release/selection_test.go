...
func TestBootstrapReleaseSelection(t *testing.T) {
	for _, role := range []string{"grok"} {
		for _, tc := range []struct{ name, version, mirror, base, status string }{
			{"default", "", "", "https://github.com/sessionbus/grok-peer/releases/download/v0.5.0", "200"},
			{"latest", "latest", "", "https://github.com/sessionbus/grok-peer/releases/download/v0.5.0", "200"},
			{"new latest release", "", "", "https://github.com/sessionbus/grok-peer/releases/download/v12.34.56", "newrelease"},
			{"default prerelease", "", "", "https://github.com/sessionbus/grok-peer/releases/download/development", "none"},
			{"latest prerelease", "latest", "", "https://github.com/sessionbus/grok-peer/releases/download/development", "none"},
			{"release page unavailable", "", "", "https://github.com/sessionbus/grok-peer/releases/download/v0.5.0", "page504"},
			...
			{"development", "development", "", "https://github.com/sessionbus/grok-peer/releases/download/development", ""},
			{"tag", "v0.5.0", "", "https://github.com/sessionbus/grok-peer/releases/download/v0.5.0", ""},
...
for arg do
 if [ "$arg" = https://github.com/sessionbus/grok-peer/releases/latest ]; then
  [ "$INSTALL_TEST_HTTP_STATUS" != transport ] || exit 7
  # A release-page outage must be irrelevant: following the redirect fails.
  for option do
   case "$option" in
    -L*|-[!-]*L*|--location|--location-trusted) printf '504 https://github.com/sessionbus/grok-peer/releases/tag/v0.5.0'; exit 0;;
   esac
  done
  case "$INSTALL_TEST_HTTP_STATUS" in
   200|page504) printf '302 https://github.com/sessionbus/grok-peer/releases/tag/v0.5.0';;
   newrelease) printf '302 https://github.com/sessionbus/grok-peer/releases/tag/v12.34.56';;
   none) printf '302 https://github.com/sessionbus/grok-peer/releases';;
   foreign) printf '302 https://example.com/releases/tag/v0.5.0';;
   prerelease) printf '302 https://github.com/sessionbus/grok-peer/releases/tag/v0.5.1-rc.1';;
   badtag) printf '302 https://github.com/sessionbus/grok-peer/releases/tag/v0.5.0/extra';;
   missing) printf '200 ';;
   *) printf '%s https://github.com/sessionbus/grok-peer/releases/latest' "$INSTALL_TEST_HTTP_STATUS";;
  esac
  exit 0
 fi
done
...
`), 0700); err != nil {
				...
				metadata := strings.Contains(string(args), "https://github.com/sessionbus/grok-peer/releases/latest\n")
